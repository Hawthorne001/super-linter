...
FROM python:3.13.0b4-alpine3.19 as clang-format
...
FROM python:3.13.0b4-alpine3.19 as python-builder
...
FROM python:3.13.0b4-alpine3.19 as npm-builder
...
FROM python:3.13.0b4-alpine3.19 as lintr-installer
...
FROM python:3.13.0b4-alpine3.19 as base_image
